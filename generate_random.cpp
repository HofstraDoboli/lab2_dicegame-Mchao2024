...
int main()
{
    ...
    */
    ...
    answer = "Rand outputs 10 random numbers between 0 and 2,147,483,647. This range is because we didn't give the function a specific range." ; // 1. Write your answer to Q1 in between " "
    ...
    answer = "This rand outputs 10 numbers between 0-4, this is based on the remainder division." ; // 2. Write your answer to Q2 in between " "
    ...
    answer = "This rand outputs the numbers 0-4 + 3, because of the same %5 but with +3." ; // 3. Write your answer to Q3 in between " "
    ...
    answer = "When srand line is removed, the random numbers generated are exactly the same. This is because the seeds time is not changing."; // 4. Write your answer to Q4 in between " "
